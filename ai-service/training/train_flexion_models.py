...
LEFT_VIDEO_DIR = os.path.join(AI_SERVICE_DIR, "data", "left_flexion")
RIGHT_VIDEO_DIR = os.path.join(AI_SERVICE_DIR, "data", "right_flexion")

LEFT_CSV_DIR = os.path.join(AI_SERVICE_DIR, "data", "left_flexion_csv")
RIGHT_CSV_DIR = os.path.join(AI_SERVICE_DIR, "data", "right_flexion_csv")
...
if __name__ == "__main__":
    ...
    # 1. Extract Left Flexion & Right Flexion videos to CSV
